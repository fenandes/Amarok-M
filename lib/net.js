...
const { ak, amk, akchar } = require("./Database/dataschema.js");
...
module.exports = async (Amarok, m, commands, chatUpdate, store) => {
  try {
    ...
    if (body.startsWith(prefix) && !icmd) {
      let amaroktext = `No such command programmed *${pushname}* senpai! Type *${prefix}help* to get my full command list!\n`;
      const reactmxv = {
        react: {
          text: '❌',
          key: m.key,
